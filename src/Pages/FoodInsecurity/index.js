...
import { getDateInterval, getMaxDate, getMinDate, handleDateParams, isValidDate, slashedMonthYear } from "../../utils";
...
export default function FoodInsecurity() {
  ...
  const startDate = getMaxDate([fromDate, presidents.getMinDataDate(), insecurity.getMinDataDate()]);
  const endDate = getMinDate([toDate, presidents.getMaxDataDate(), insecurity.getMaxDataDate()]);
      ...
      <Container className="Content-wrapper">
        ...
        <Row>
          <Col md={6} sm={{ order: 2 }}>
            ...
            <p>
              O IBGE classifica a insegurança alimentar, que pode ser crônica ou temporária, em três níveis: leve, moderada e grave. 
              Esta última é caracterizada pela efetiva falta de alimentos. 
            </p>
            <p>
              Suas causas podem ser diversas. Crises de desabastecimento, mudanças climáticas, altos preços, desemprego, guerras e etc.
            </p>
          </Col>
        ...
        <Row>
          <Col>
            ...
            <Sources sources={[ ...insecurity.getSources(), ...presidents.getSources() ]} />
